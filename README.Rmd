...
Launch the [`make.R`](https://github.com/BarbyCastillo/proyectorepro/tree/main/make.R)
file with:
...
check out our [Contributor Guidelines](https://github.com/BarbyCastillo/proyectorepro/blob/main/CONTRIBUTING.md).
